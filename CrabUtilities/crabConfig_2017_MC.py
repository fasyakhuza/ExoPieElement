...
workname='setup_2017_v07' ##do we need to change this to be like that, instead of 'setup_2018_v07' ?
reqname= 'RunIISummer20UL17_TREEMAKER' ##'DYJetsToLL_M_50_HT_400to600_TuneCP5_13TeV_30K' ## this is temporrt, will be changed by the multicrab
...
config.JobType.pyCfgParams = ['runOnMC=True','runOn2017=True'] ##do we need to change 'runOn2018=True' to be 'runOn2017=True'?
...
config.Site.storageSite = "T2_TW_NCHC" #"T2_CH_CERN"
